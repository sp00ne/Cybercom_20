...
public class FlowFragment extends Fragment implements View.OnClickListener {
    ...
    private View inflateAndSetup(ViewGroup container) {
        ...
        if(AnimationClass.PREV_BACKGROUND != null){
            AnimationClass.switchSectionColor(3, rootView);
        }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        FloatingActionButton fab = (FloatingActionButton) view.findViewById(R.id.action_picture);
    ...
    /**
     * Opens the camera specified by {@link FlowFragment#mCameraId}.
     */
